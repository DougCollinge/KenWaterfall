/****************************************************************************
** Meta object code from reading C++ file 'guitest.hpp'
**
...
#error "The header file 'guitest.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 8, 12), // "slotReadMore"
QT_MOC_LITERAL(2, 21, 0), // ""
QT_MOC_LITERAL(3, 22, 12), // "slotUpdateVU"
QT_MOC_LITERAL(4, 35, 11), // "slotVolChgd"
QT_MOC_LITERAL(5, 47, 1) // "v"

    },
    "guitest\0slotReadMore\0\0slotUpdateVU\0"
    "slotVolChgd\0v"
};
...
void guitest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotReadMore(); break;
        case 1: _t->slotUpdateVU(); break;
        case 2: _t->slotVolChgd((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}

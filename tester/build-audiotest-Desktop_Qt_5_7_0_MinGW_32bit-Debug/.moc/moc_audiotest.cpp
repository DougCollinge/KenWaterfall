/****************************************************************************
** Meta object code from reading C++ file 'audiotest.hpp'
**
...
#include "../../audiotest/audiotest.hpp"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'audiotest.hpp' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 10, 12), // "slotUpdateVU"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12) // "slotReadMore"

    },
    "audiotest\0slotUpdateVU\0\0slotReadMore"
};
...
void audiotest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotUpdateVU(); break;
        case 1: _t->slotReadMore(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
